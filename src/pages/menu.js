        ...
        <div class="row">
          <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="menu-section" style={{ marginTop: "70px" }}>
              ...
              <div class="menu-item">
                <div class="menu-item-name">Fantasia</div>
                <div class="menu-item-price">48</div>
                <div class="menu-item-price2">35</div>
                <div class="menu-item-description">
          ...
          <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="menu-section" style={{ marginTop: "80px" }}>
              ...
              <div class="menu-item">
                <div class="menu-item-name">Della Casa</div>
                <div class="menu-item-price">33</div>
                <div class="menu-item-description">
                  spaghetti / krem z cukini / guanciale / pecorino
                </div>
              </div>
              <div class="menu-item">
              ...
              <div class="menu-item">
                ...
                <div class="menu-item-description">
                  tagliatelle / łosoś / pomidorki koktajlowe / czosnek /
                  pietruszka / śmietanka
                </div>
              </div>
              <div class="menu-item">
